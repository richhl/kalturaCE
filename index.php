<?
clearstatcache();
if (!file_exists('logs/.kinstalled') || !filesize('logs/.kinstalled'))
{
...
require_once(SF_ROOT_DIR.'/config/kConf.php');
$server_url = $server_host = 'http://'.kConf::get('www_host');
include(SF_ROOT_DIR.'/../api_v3/web/system/batchwatchStatus.php');
?>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01//EN">
<html lang="en">
<head>
    <title>Kaltura Community Edition Server - Home Page</title>
    <link rel="stylesheet" rev="stylesheet" media="screen" href="install/css/kce.css" />
    <script src="install/js/functions.js"></script>
</head>

<body id="kce_home">
 <div id="pageWrap">
  <h1><img src="install/images/k_logo.png" width="135" height="24" alt="Kaltura - creating together"> &nbsp; CE Server</h1>
  <div id="stepWrap">
...
try{
var pageTracker = _gat._getTracker("<?php kConf::get('ga_account'); ?>");
pageTracker._trackPageview("CELandingPage/<?php echo $GA_ACTION; ?>");
} catch(err) {}</script>
</body>
</html>
