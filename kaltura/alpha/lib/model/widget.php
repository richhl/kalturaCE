...
class widget extends Basewidget
{
	...
	public static function createDefaultWidgetForPartner ( $partner_id , $subp_id , $kdp_ui_conf_id = 199 )
	{
		if ( ! $kdp_ui_conf_id ) $kdp_ui_conf_id = 199;
		
		$partner = PartnerPeer::retrieveByPK( $partner_id );
		$widget_id = $partner->getDefaultWidgetId(); 
		
		if ( $kdp_ui_conf_id != null && $kdp_ui_conf_id != 199 ) $widget_id .= "_{$kdp_ui_conf_id}";
