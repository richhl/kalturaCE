...
class roughcutEntryMapBuilder {
	...
	public function doBuild()
	{
		...
		$tMap->addForeignKey('ROUGHCUT_ID', 'RoughcutId', 'string', CreoleTypes::VARCHAR, 'entry', 'ID', false, 10);

		$tMap->addColumn('ROUGHCUT_VERSION', 'RoughcutVersion', 'int', CreoleTypes::INTEGER, false, null);

		$tMap->addForeignKey('ROUGHCUT_KSHOW_ID', 'RoughcutKshowId', 'string', CreoleTypes::VARCHAR, 'kshow', 'ID', false, 10);
