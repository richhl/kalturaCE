...
class PartnerActivityMapBuilder {
	...
	public function doBuild()
	{
		...
		$tMap->addColumn('AMOUNT', 'Amount', 'string', CreoleTypes::BIGINT, false, null);

		$tMap->addColumn('AMOUNT1', 'Amount1', 'string', CreoleTypes::BIGINT, false, null);

		$tMap->addColumn('AMOUNT2', 'Amount2', 'string', CreoleTypes::BIGINT, false, null);
