...
class kshowMapBuilder {
	...
	public function doBuild()
	{
		...
		$tMap->addPrimaryKey('ID', 'Id', 'string', CreoleTypes::VARCHAR, true, 10);

		$tMap->addForeignKey('PRODUCER_ID', 'ProducerId', 'int', CreoleTypes::INTEGER, 'kuser', 'ID', false, null);

		$tMap->addColumn('EPISODE_ID', 'EpisodeId', 'string', CreoleTypes::VARCHAR, false, 10);
		...
		$tMap->addColumn('SHOW_ENTRY_ID', 'ShowEntryId', 'string', CreoleTypes::VARCHAR, false, 10);
