...
abstract class BaseBatchJob extends BaseObject  implements Persistent {
	...
	public function setProcessorLocation($v)
	{
		...
		if ($this->processor_location !== $v) {
			...
			$this->modifiedColumns[] = BatchJobPeer::PROCESSOR_LOCATION;
		}
	...
	public function hydrate(ResultSet $rs, $startcol = 1)
	{
		try {
			...
			$this->parent_job_id = $rs->getInt($startcol + 21);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(BatchJobPeer::PROCESSOR_LOCATION)) $criteria->add(BatchJobPeer::PROCESSOR_LOCATION, $this->processor_location);
