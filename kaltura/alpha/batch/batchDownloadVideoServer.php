...
$download_client = new myBatchDownloadVideoServer ( $script_name , "" , $server_cmd_path , $server_res_path , $commercial_server_cmd_path );
SET_CONTEXT ( "DVS" ); // this is to prevent writing TRACEs to the output
$download_client->doConvert();
