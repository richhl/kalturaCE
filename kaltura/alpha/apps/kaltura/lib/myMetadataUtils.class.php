...
//		echo $temp_xml_doc->saveXML( );
	...
	public static function updateAllMetadataVersionsRelevantForEntry ( $entry , $version_to_update )
	{
		...
		kLog::log ( "updateAllMetadataVersionsRelevantForEntry [" . $entry->getId() . "] version_to_update [$version_to_update] status [$status]");
		...
		kLog::log ( "updateAllMetadataVersionsRelevantForEntry [" . $entry->getId() . "] updated " . implode ("," , $versions_updated ) );
