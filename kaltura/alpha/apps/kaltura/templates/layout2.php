...
<head>
	...
	<script type="text/javascript">
		var ENTRY_MEDIA_TYPE_VIDEO = <? echo entry::ENTRY_MEDIA_TYPE_VIDEO; ?>;
		var ENTRY_MEDIA_TYPE_IMAGE = <? echo entry::ENTRY_MEDIA_TYPE_IMAGE; ?>;
		var ENTRY_MEDIA_TYPE_AUDIO = <? echo entry::ENTRY_MEDIA_TYPE_AUDIO; ?>;
		var ENTRY_MEDIA_TYPE_TEXT = <? echo entry::ENTRY_MEDIA_TYPE_TEXT; ?>;
		var ENTRY_MEDIA_TYPE_SHOW = <? echo entry::ENTRY_MEDIA_TYPE_SHOW; ?>;
		
		var ENTRY_MEDIA_SOURCE_FILE = <? echo entry::ENTRY_MEDIA_SOURCE_FILE; ?>;
		var ENTRY_MEDIA_SOURCE_FLICKR = <? echo entry::ENTRY_MEDIA_SOURCE_FLICKR; ?>;
		var ENTRY_MEDIA_SOURCE_YOUTUBE = <? echo entry::ENTRY_MEDIA_SOURCE_YOUTUBE; ?>;
		var ENTRY_MEDIA_SOURCE_URL = <? echo entry::ENTRY_MEDIA_SOURCE_URL; ?>;
		var ENTRY_MEDIA_SOURCE_WEBCAM = <? echo entry::ENTRY_MEDIA_SOURCE_WEBCAM; ?>;
		var ENTRY_MEDIA_SOURCE_MYSPACE = <? echo entry::ENTRY_MEDIA_SOURCE_MYSPACE; ?>;
		var ENTRY_MEDIA_SOURCE_PHOTOBUCKET = <? echo entry::ENTRY_MEDIA_SOURCE_PHOTOBUCKET; ?>;
		var ENTRY_MEDIA_SOURCE_NYPL = <? echo entry::ENTRY_MEDIA_SOURCE_NYPL; ?>;
		var ENTRY_MEDIA_SOURCE_JAMENDO = <? echo entry::ENTRY_MEDIA_SOURCE_JAMENDO; ?>;
		var ENTRY_MEDIA_SOURCE_CCMIXTER = <? echo entry::ENTRY_MEDIA_SOURCE_CCMIXTER; ?>;
		var ENTRY_MEDIA_SOURCE_CURRENT = <? echo entry::ENTRY_MEDIA_SOURCE_CURRENT; ?>;
		
		var COMMENT_TYPE_KSHOW = <? echo comment::COMMENT_TYPE_KSHOW; ?>;
		var COMMENT_TYPE_DISCUSSION = <? echo comment::COMMENT_TYPE_DISCUSSION; ?>;
		var COMMENT_TYPE_USER = <? echo comment::COMMENT_TYPE_USER; ?>;
		var COMMENT_TYPE_SHOUTOUT = <? echo comment::COMMENT_TYPE_SHOUTOUT; ?>;
		
		var KSHOW_PERMISSION_INVITE_ONLY = <? echo kshow::KSHOW_PERMISSION_INVITE_ONLY; ?>;
		
		var KSHOWKUSER_VIEWER_USER = <? echo KshowKuser::KSHOWKUSER_VIEWER_USER; ?>;
		var KSHOWKUSER_VIEWER_SUBSCRIBER = <? echo KshowKuser::KSHOWKUSER_VIEWER_SUBSCRIBER; ?>;
		var KSHOWKUSER_VIEWER_PRODUCER = <? echo KshowKuser::KSHOWKUSER_VIEWER_PRODUCER; ?>;
...
<body class="cls_body_b">
	...
	<div id="wrap">
		...
		<div id="header2">
			<a href="<? echo url_for('/corp'); ?>" class="logo"></a>
			<div class="outerwrap">
				<div class="innerwrap sch_boxBorders">
					<ul class="userMenu">	
						<li class="bordered"><a href='<? echo url_for('/corp'); ?>'>Home</a></li>
					...
					<ul class="bottomLinks userMenu">
						<li class="bordered"><a href="<? echo url_for('/edit')."?kshow_id=2"; ?>">Try out video editor</a></li>
						<li><a href="<? echo url_for('/tour'); ?>">Take the tour</a></li>
					</ul><!-- end bottomLinks-->
