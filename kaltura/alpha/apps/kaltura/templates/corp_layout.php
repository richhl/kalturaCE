...
<body>
	<div id="wrap">
		<div id="header">
			...
			<a href="<? echo url_for('/corp'); ?>" class="logo" title="Kaltura &ndash; Creating Together"></a>
			<ul class="userMenu">	
				<li class="last"><a href='<? echo url_for('/corp/contact'); ?>'>Contact</a></li>
				<?php
				/*
...
<form action="<? echo url_for("/corp/search"); ?>" id="searchbox_014173296589949272966:uncsmpomy4e">
...
<!-- Google CSE Search Box Ends -->
			...
			<ul class="navMenu <? if ($activeTab == "home") echo "corpHome"; ?>">
				<?
			...
			<? if ($activeTab == "home") echo '<div id="bigButton"><a href="' . url_for('/corp/download') . '"></a><div></div></div>'; ?>
