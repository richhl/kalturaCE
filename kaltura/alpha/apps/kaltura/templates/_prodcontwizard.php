	...
	<div class="container">
		<fieldset>
			<div class="col">
				...
				<label><input type="radio" class="radio" id="prod_ViewShow1" name="prod_ViewShow" checked="checked" value="<? echo kshow::KSHOW_PERMISSION_EVERYONE; ?>" />Everyone</label>
				<label><input type="radio" class="radio" id="prod_ViewShow2" name="prod_ViewShow" value="<? echo kshow::KSHOW_PERMISSION_JUST_ME; ?>" />Just me (draft)</label>
				<label><input type="radio" class="radio" id="prod_ViewShow3" name="prod_ViewShow" value="<? echo kshow::KSHOW_PERMISSION_INVITE_ONLY; ?>" />By invitation only</label><div class="pass"><input id="prod_ViewShow_Invite_pass" defValue="Enter password"/>Send password by email to friends.</div>
			</div>
			<div class="col">
				<span>Who can contribute media</span>
				<label><input type="radio" class="radio" id="prod_ContributeShow1" name="prod_ContributeShow" checked="checked" value="<? echo kshow::KSHOW_PERMISSION_REGISTERED; ?>" />Everyone</label>
				<label><input type="radio" class="radio" id="prod_ContributeShow2" name="prod_ContributeShow" value="<? echo kshow::KSHOW_PERMISSION_JUST_ME; ?>" />Just me</label>
				<label><input type="radio" class="radio" id="prod_ContributeShow3" name="prod_ContributeShow" value="<? echo kshow::KSHOW_PERMISSION_INVITE_ONLY; ?>" />By invitation only</label><div class="pass"><input id="prod_ContributeShow_Invite_pass" defValue="Enter password"/>Send password by email to friends.</div>
			</div>
			<div class="col">
				<span>Who can edit</span>
				<label><input type="radio" class="radio" id="prod_EditShow1" name="prod_EditShow" checked="checked" value="<? echo kshow::KSHOW_PERMISSION_REGISTERED; ?>" />Everyone</label>
				<label><input type="radio" class="radio" id="prod_EditShow2" name="prod_EditShow" value="<? echo kshow::KSHOW_PERMISSION_JUST_ME; ?>" />Just me</label>
				<label><input type="radio" class="radio" id="prod_EditShow3" name="prod_EditShow" value="<? echo kshow::KSHOW_PERMISSION_INVITE_ONLY; ?>" />By invitation only</label><div class="pass"><input id="prod_EditShow_Invite_pass" defValue="Enter password"/>Send password by email to friends.</div>
			</div>
		</fieldset>
	</div>
</div>
