...
if (in_array( $partner_id, array(  ))) // only allow reports tab to selected partners
{
  $allow_reports = true;
}
...
?>
	...
	<div id="kmcHeader">
	 ...
	 <li><a id="reports" href="javascript:void(0)"><span>Reports&nbsp;&amp;&nbsp;Analytics</span></a></li>
	 <?php } ?>
	 </ul>

     <div>
      <span>Hi <?php echo $screen_name ?></span><br />
      <a href="<?php echo $service_url ?>/lib/pdf/KMC_Quick_Start_Guide.pdf" target="_blank">Quickstart Guide</a> &nbsp; | &nbsp; <a href="javascript:logout()">Logout</a> &nbsp; | &nbsp; <a target="_blank" onclick="return openSupport(this);" href="<?php echo $support_url; ?>">Support</a>
	 </div>
...
//				wmode: "opaque" ,
	...
	if ( module_name == "appstudio" ) 
	{
		...
		var flashVars = {	
				...
				'kdpUrl' : "<?php echo $flash_dir ?>/kdp/v2.5.2.30923/kdp.swf",
				'disableurlhashing' : '<? echo $disableurlhashing; ?>'
				};
