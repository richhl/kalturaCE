			...
			*/ ?>
			<fieldset>
				<div class="item">
					...
					<input id="partner_id" name="partner_id" type="text" readonly="readonly" style="width:80px" value="<?=$partner->getId(); ?>"/>
				</div>
				<div class="item">
					<label for="sub_partner_id">Sub-Partner Id:</label>
					<input id="sub_partner_id" name="sub_partner_id" type="text" readonly="readonly" style="width:80px" value="<?=$sub_partner_id; ?>"/>
				</div>
				<div class="item">
					<label for="aministrator_secret">Administrator Secret:</label>
					<input id="aministrator_secret" name="aministrator_secret" type="text" readonly="readonly" style="width:250px" value="<?=$partner->getAdminSecret(); ?>"/>
				</div>
				<div class="item">
					<label for="web_service_secret">Web Service Secret:</label>
					<input id="web_service_secret" name="web_service_secret" type="text" readonly="readonly" style="width:250px" value="<?=$partner->getSecret(); ?>"/>
				</div>
			</fieldset>
		</form>
</div><!-- page_new_app -->
