...
function createSelect ( $id , $name , $default_value , $list_name , $pid_str = null )
{
	...
	$arrays = array ( "format_list" => $format_list , "media_type" => $media_type_list , "media_source" => $media_source_list ,
		...
		"notification_type" => array_merge ( array ( "" => "All" )  , notification::getNotificationTypeMap() ) ,
...
<form id="theform" method="post" action="<? echo $SERVICE_URL ?>" target="target_frame">
<div>
...
<? if  ( !$limited) { // add the history selection ?>
<tr><td>url</td>
...
<? // 		<option value="reportkshow">report kshow</option> ?>
