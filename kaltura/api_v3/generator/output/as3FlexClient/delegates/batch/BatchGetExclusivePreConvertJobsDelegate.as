package com.kaltura.delegates.batch
{
	...
	public class BatchGetExclusivePreConvertJobsDelegate extends WebDelegateBase
	{
		public function BatchGetExclusivePreConvertJobsDelegate(call:KalturaCall, config:KalturaConfig)
		{
			super(call, config);
		}
