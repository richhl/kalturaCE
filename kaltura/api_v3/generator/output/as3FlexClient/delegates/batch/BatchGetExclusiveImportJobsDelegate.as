package com.kaltura.delegates.batch
{
	...
	public class BatchGetExclusiveImportJobsDelegate extends WebDelegateBase
	{
		public function BatchGetExclusiveImportJobsDelegate(call:KalturaCall, config:KalturaConfig)
		{
			super(call, config);
		}
