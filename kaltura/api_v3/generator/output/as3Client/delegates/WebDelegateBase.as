package com.kaltura.delegates {
	...
	public class WebDelegateBase extends EventDispatcher implements IKalturaCallDelegate {
		...
		private static const CONNECT_TIME : int = 30000; //30 secs
		...
		protected function sendRequest():void {
			...
			var req:URLRequest = new URLRequest(_config.domain +"/"+_config.srvUrl+"?service="+call.service+"&action="+call.action);
		...
		{ 
			...
			if(xml.result.hasOwnProperty('error')){
				...
				kError.errorCode = xml.result.error.code;
