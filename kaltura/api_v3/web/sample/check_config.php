...
<body>
<div class="wrap">
    In order to try the sample implementation you have to define the following values config.php (<b><? echo realpath("config.php") ?><b>):<br />
    <table>
        <tr>
    ...
    * Note that using the SESSION configuration, the sample implementation will work until you close your browser.<br /><br />
    <form action="set_session_config.php" method="POST">
      ...
      <input type="text" name="server_url" value="<? echo kConf::get('www_host'); ?>" /></label><br /><br />
