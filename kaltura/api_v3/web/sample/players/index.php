		...
		<div id="contWrap" class="innerpage playersPage">
			...
			<div id="row1" class="clearfix">
				...
				<script type="text/javascript">
					...
					swfobject.embedSWF("<?php echo SERVER_URL; ?>/kwidget/wid/_<?php echo PARTNER_ID; ?>/ui_conf_id/48110/entry_id/1i5ojrn9ts", "kplayer1", "400", "362", "9.0.0", false, null, params);
					swfobject.embedSWF("<?php echo SERVER_URL; ?>/kwidget/wid/_<?php echo PARTNER_ID; ?>/ui_conf_id/48111/entry_id/1i5ojrn9ts", "kplayer2", "400", "362", "9.0.0", false, null, params);
					
					var flashVars = {
						entryId: "1i5ojrn9ts"
					};
					<? /* FIXME: old player version is used here, so the embed code and the functions are different */ ?>
