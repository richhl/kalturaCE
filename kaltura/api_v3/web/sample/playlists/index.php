		...
		<div id="contWrap" class="innerpage playlistsPage">
			...
			<div id="row1" class="clearfix">
				...
				<script type="text/javascript">
					 var kaltura_swf = new SWFObject("<?php echo SERVER_URL; ?>/kwidget/wid/_1/ui_conf_id/48206", "kaltura_playlist_horizontal", "724", "322", "9", "#ffffff");
				...
				<script type="text/javascript">
					 var kaltura_swf = new SWFObject("<?php echo SERVER_URL; ?>/kwidget/wid/_1/ui_conf_id/48204", "kaltura_playlist_vertical", "400", "600", "9", "#ffffff");
					 kaltura_swf.addParam("wmode", "opaque");
