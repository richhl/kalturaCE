...
<ul id="show_options">
 <li><a href="javascript:sh('howwhen')">What is this and how should I use it ?</a>
  <ul id="howwhen">
   ...
   <li>All batch processes are being controlled and watched by two batch scripts:
     <ul>
	 ...
	 <li>BatchWatch: the main process responsible of monitoring the various running
...
//			"<span>" . print_r ( $batch_status->getInProcData() , true ) . "</span><br/>" ;*/
	...
	echo	"<td>" .
			"<p><a href='javascript:updateBatchStatus ( \"" . $batch_status->batch_name . "\" , \"start\" )'>Start</a></p>" .
			"<p><a href='javascript:updateBatchStatus ( \"" . $batch_status->batch_name . "\" , \"stop\" )'>Stop</a></p>" .
			"<p><a href='javascript:updateBatchStatus ( \"" . $batch_status->batch_name . "\" , \"restart\" )'>Restart</a></p>" .
		"</tr>";
}
 ?>
