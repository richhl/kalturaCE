		...
		<div class="left-content">
			...
			<div id="services">
				...
				<?php foreach($services as $serviceId): ?>
					...
					<li class="service<?php echo($currentService == $serviceId) ? " expended": ""?>">
						<a href="?service=<?echo $serviceId; ?>"><?php echo $serviceReflector->getServiceName(); ?></a>
						<ul class="actions">
						<?php foreach($actions as $actionId => $actionName): ?>
							<li class="action"><a href="?service=<?echo $serviceId; ?>&action=<?php echo $actionId; ?>"><?php echo $actionName;?></a></li>
						<?php endforeach; ?>
						</ul>
					</li>
				<?php endforeach; ?>
			...
			<div id="objects">
				...
				<?php foreach($objects as $object): ?>
					<li id="object_<?echo $object->getType(); ?>">
						<a href="?object=<?echo $object->getType(); ?>"><?php echo $object->getType(); ?></a>
					</li>
				<?php endforeach; ?>
				</ul>
			</div>
			...
			<div id="enums">
				...
				<?php foreach($enums as $enum): ?>
					<li id="object_<?echo $enum->getType(); ?>">
						<a href="?object=<?echo $enum->getType(); ?>" name="<?echo $enum->getType(); ?>"><?php echo $enum->getType(); ?></a>
					</li>
				<?php endforeach; ?>
				</ul>
			</div>
			...
			<div id="enums">
				...
				<?php foreach($stringEnums as $stringEnum): ?>
					<li id="object_<?echo $stringEnum->getType(); ?>">
						<a href="?object=<?echo $stringEnum->getType(); ?>" name="<?echo $stringEnum->getType(); ?>"><?php echo $stringEnum->getType(); ?></a>
					</li>
				<?php endforeach; ?>
				</ul>
			</div>
