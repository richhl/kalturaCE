...
<div id="stepDetails">
	...
	{
          echo '<div class="passed"><h2 class="passed"><strong>Configuration is not ideal, some warning found:</strong></h2>';
	  echo '<ul>'.implode($warnings).'</ul><p>You can <a href="http://kaltura.org/forums/kaltura-server-community-edition-forums" target="_blank">get help at the community forums</a>, or report a bug / make a feature request through <a href="http://corp.kaltura.com/support/form/project/13" target="_blank">issues tracker</a></p>';
	  echo '<h2>Fixed the problems? <a href="prepare_install.php">Check Again</a></h2><h2><a href="database_info.php">Continue , ignoring the warnings &raquo;</a></h2>';
	}
	else
	{
