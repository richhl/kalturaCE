...
class KalturaEntryFilter
{
	...
	public $multiLikeAndTagsOrAdminTags;
	public $multiLikeAndTagsOrAdminTagsOrName;
	public $matchAndSearchText;
	public $matchOrSearchText;
	public $orderBy;
	public $limit;
}
...
class KalturaUiConfFilter
{
	const ORDER_BY_CREATED_AT_ASC = "+created_at";
	const ORDER_BY_CREATED_AT_DESC = "-created_at";
	const ORDER_BY_UPDATED_AT_ASC = "+updated_at";
	const ORDER_BY_UPDATED_AT_DESC = "-updated_at";
	const ORDER_BY_STATUS_ASC = "+status";
	const ORDER_BY_STATUS_DESC = "-status";
	const ORDER_BY_OBJ_TYPE_ASC = "+obj_type";
	const ORDER_BY_OBJ_TYPE_DESC = "-obj_type";
	const ORDER_BY_ID_ASC = "+id";
	const ORDER_BY_ID_DESC = "-id";
...
class KalturaClient extends KalturaClientBase
{
	...
	public function addDvdEntry(KalturaSessionUser $kalturaSessionUser, KalturaEntry $dvdEntry)
	{
		...
		$this->addOptionalParam($params, "dvdEntry_securityPolicy", $dvdEntry->securityPolicy);
	...
	public function addEntry(KalturaSessionUser $kalturaSessionUser, $kshowId, KalturaEntry $entry, $uid = null, $quickEdit = null)
	{
		$params = array();
		...
		$this->addOptionalParam($params, "entry_securityPolicy", $entry->securityPolicy);
		$this->addOptionalParam($params, "entry_adminTags", $entry->adminTags);
		$this->addOptionalParam($params, "uid", $uid);
		$this->addOptionalParam($params, "quick_edit", $quickEdit);
	...
	public function addPlaylist(KalturaSessionUser $kalturaSessionUser, KalturaEntry $playlist)
	{
		...
		$this->addOptionalParam($params, "playlist_securityPolicy", $playlist->securityPolicy);
	...
	public function addUiConf(KalturaSessionUser $kalturaSessionUser, KalturaUiConf $uiconf)
	{
		...
		$this->addOptionalParam($params, "uiconf_confFile2", $uiconf->confFile2);
	...
	public function cloneUiConf(KalturaSessionUser $kalturaSessionUser, $uiconfId, $detailed = null, $newName = null)
	{
		$params = array();
		$params["uiconf_id"] = $uiconfId;
		$this->addOptionalParam($params, "detailed", $detailed);
		$this->addOptionalParam($params, "new_name", $newName);

		$result = $this->hit("cloneuiconf", $kalturaSessionUser, $params);
		return $result;
	}

	public function contactSalesforce(KalturaSessionUser $kalturaSessionUser, $name = null, $phone = null, $comments = null, $services = null)
	{
		$params = array();
		$this->addOptionalParam($params, "name", $name);
		$this->addOptionalParam($params, "phone", $phone);
		$this->addOptionalParam($params, "comments", $comments);
		$this->addOptionalParam($params, "services", $services);

		$result = $this->hit("contactsalesforce", $kalturaSessionUser, $params);
		return $result;
	}
	...
	public function deleteUiconf(KalturaSessionUser $kalturaSessionUser, $uiconfId)
	{
		$params = array();
		$params["uiconf_id"] = $uiconfId;
	...
	public function executePlaylistFromContent(KalturaSessionUser $kalturaSessionUser, KalturaEntry $playlist, $fp = null, $filter1 = null, $filter2 = null, $filter3 = null, $filter4 = null, $detailed = null, $pageSize = 10, $page = 1, $useFilterPuserId = null)
	{
		$params = array();
		$this->addOptionalParam($params, "playlist_name", $playlist->name);
		$this->addOptionalParam($params, "playlist_tags", $playlist->tags);
	...
	public function getPartner(KalturaSessionUser $kalturaSessionUser, $partnerAdminEmail, $cmsPassword, $partnerId, $detailed = null)
	{
		$params = array();
	...
	public function getPartnerInfo(KalturaSessionUser $kalturaSessionUser, $partnerId, $detailed = null)
	{
		$params = array();
		$params["partner_id"] = $partnerId;
		$this->addOptionalParam($params, "detailed", $detailed);
	...
	public function getPartnerUsage(KalturaSessionUser $kalturaSessionUser, $partnerId, $year, $month = null, $resolution = null)
	{
		$params = array();
		$params["partner_id"] = $partnerId;
		$params["year"] = $year;
		$this->addOptionalParam($params, "month", $month);
		$this->addOptionalParam($params, "resolution", $resolution);

		$result = $this->hit("getpartnerusage", $kalturaSessionUser, $params);
		return $result;
	}
	...
	public function getPlaylistStatsFromContent(KalturaSessionUser $kalturaSessionUser, KalturaEntry $playlist, $fp = null, $filter1 = null, $filter2 = null, $filter3 = null, $filter4 = null, $detailed = null, $pageSize = 10, $page = 1, $useFilterPuserId = null)
	{
		$params = array();
		$this->addOptionalParam($params, "playlist_name", $playlist->name);
		$this->addOptionalParam($params, "playlist_tags", $playlist->tags);
	...
	public function getWidget(KalturaSessionUser $kalturaSessionUser, $widgetId, $detailed = null, $uiConfId = null)
	{
		$params = array();
	...
	{
		$params = array();
		$this->addOptionalParam($params, "filter__in_id", $filter->inId);
	...
	public function registerPartner(KalturaSessionUser $kalturaSessionUser, KalturaPartner $partner, $cmsPassword = null)
	{
		...
		$this->addOptionalParam($params, "partner_allowQuickEdit", $partner->allowQuickEdit);
		$this->addOptionalParam($params, "partner_mergeEntryLists", $partner->mergeEntryLists);
		$this->addOptionalParam($params, "partner_maxUploadSize", $partner->maxUploadSize);
	...
	public function resetAdminPassword(KalturaSessionUser $kalturaSessionUser, $email)
	{
		$params = array();
		$params["email"] = $email;
	...
	public function updateAdminPassword(KalturaSessionUser $kalturaSessionUser, $adminKuserEmail, $adminKuserPassword, $newPassword, $newEmail = null)
	{
		$params = array();
		$params["adminKuser_email"] = $adminKuserEmail;
		$params["adminKuser_password"] = $adminKuserPassword;
		$params["new_password"] = $newPassword;
		$this->addOptionalParam($params, "new_email", $newEmail);
