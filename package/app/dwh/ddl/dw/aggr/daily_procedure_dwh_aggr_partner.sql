...
BEGIN
	...
	/* set data from kalturadw.dwh_fact_partner_activities */
	SET @s = CONCAT('
    	INSERT INTO kalturadw.',aggr_table,'
    		(partner_id, 
    		date_id, 
	...
	/* set data from kalturadw.dwh_aggr_partner
	 * this will calculate the column aggr_storage for the day based on all the previous days for each partner 
	 * */
	SET @s = CONCAT('
    	INSERT INTO kalturadw.',aggr_table,'
    		(partner_id, 
	...
	/*	 set data from kalturadw.dwh_dim_kusers */ 
	SET @s = CONCAT('
    	INSERT INTO kalturadw.',aggr_table,'
    		(partner_id, 
    		date_id, 
	...
	/*	 set data from kalturadw.dwh_dim_widgets */ 
	SET @s = CONCAT('
    	INSERT INTO kalturadw.',aggr_table,'
    		(partner_id, 
    		date_id, 
	...
	/* finally - call the partner_daily_usage aggregaton */
