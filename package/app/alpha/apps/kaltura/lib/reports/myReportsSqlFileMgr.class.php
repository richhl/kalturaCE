...
kLog::log ( __METHOD__. ": [$type_str] [$flavor_str] [$add_search_text] [$object_ids] -> [$res]" );		
		return $res;
	}
	
	private static function getSqlFilePathImpl ( $type_str , $flavor_str , $add_search_text , $object_ids , $recursion_count = 0)
	{
//kLog::log ( __LINE__ . ": [$type_str] [$flavor_str] [$add_search_text] [$object_ids] [$recursion_count]" );		
		$recursion_count++;
