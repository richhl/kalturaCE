...
<div id="wrapper">
	<form action="" method="post" enctype="multipart/form-data" name="support" id="support">
		...
		<fieldset>
			...
			<p><label>* Partner Id: <input type="text" class="required" name="partner_id" id="partner_id" value="<?php echo $pid; ?>" /><img src="/lib/images/kmc/error.gif" height="20" width="20" alt="error" /></label></p>
            <p><label>* Your Name: <input type="text" class="required" name="your_name" id="your_name" /><img src="/lib/images/kmc/error.gif" height="20" width="20" alt="error" /></label></p>
            <p><label>* Email: <input type="text" class="required" name="email" id="email" value="<?php echo $email; ?>" /><img src="/lib/images/kmc/error.gif" height="20" width="20" alt="error" /></label></p>
            <p><label id="checkbox">* Confirm email: <input type="checkbox" class="required" id="confirm_email" value="confirmed" /><em>&nbsp;this is the (only) email to which we will respond</em><img src="/lib/images/kmc/error.gif" height="20" width="20" alt="error" /></label></p>
		</fieldset>
		...
		<fieldset>
			...
			<p><label>* Component/ Feature:
					...
					<img src="/lib/images/kmc/error.gif" height="20" width="20" alt="error" /></label></p>
			...
			<p>
				<label>* Description:
					...
					<img src="/lib/images/kmc/error.gif" height="20" width="20" alt="error" />
				</label>
			</p>
			<p>
