...
<script type="text/javascript">
	...
	if ( !loginF ( null , null , null , null , true ) ) {
		var flashVars = {
			...
			urchinNumber: "<?php echo kConf::get('ga_account'); ?>"
		}
		...
		var params = {
			...
			quality: "high",
			wmode: "window" ,
			movie: "<?php echo $flash_dir ?>/kmc/login/<?php echo kConf::get('kmc_login_version'); ?>/login.swf"
		};
		swfobject.embedSWF("<?php echo $flash_dir ?>/kmc/login/<?php echo kConf::get('kmc_login_version'); ?>/login.swf", "login_swf", "384", "350", "9.0.0", false, flashVars, params);
	}
</script>
