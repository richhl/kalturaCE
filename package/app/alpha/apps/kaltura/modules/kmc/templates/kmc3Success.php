...
$rtmp_host = myPartnerUtils::getRtmpUrl($partner_id);			/*** move to action ***/
...
?>
<?php													/*** move to action ***/
	$defaultUiconfsArray = array();									/*** move to action ***/
	...
	foreach($playlist_uiconf_list as $uiconf)
	{
		...
		if($uiconf->getPartnerId()) // not default
		{
	...
	$ui_confs_playlist = json_encode(array_merge($defaultUiconfsArray, $silverLightPlaylistUiConfs, $partnerUiconfsArray, $jw_uiconf_playlist));
						/*** move to action ***/
	$defaultUiconfsArray = array();									/*** move to action ***/
	$partnerUiconfsArray = array();
	...
	$ui_confs_player = json_encode(array_merge($defaultUiconfsArray, $silverLightPlayerUiConfs, $partnerUiconfsArray, $jw_uiconfs_array));
?>
...
<!--	 <li><a id="Advertising" href="#"><span>Advertising</span></a></li>-->
     ...
     <div id="user_links">
      ...
      <?php } else { ?>
      <a id="Quickstart Guide" href="#" target="_blank">Quickstart Guide</a> &nbsp; | &nbsp;
