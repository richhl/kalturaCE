...
//abstract class kalturaCmsActions extends kalturaCmsAction
//{
//	/**
...
//		{
//			// action not found
//			$error = 'kalturaCmsAction initialization failed for module "%s", action "%s". You must create a "%s" method.';
...
//		{
//			$this->getContext()->getLogger()->info('{kalturaCmsAction} call "'.get_class($this).'->'.$actionToRun.'()'.'"');
//		}
//
//		// run action
