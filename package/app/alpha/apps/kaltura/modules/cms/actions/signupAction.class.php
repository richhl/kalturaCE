...
class signupAction extends kalturaCmsAction
{
	...
	private function sendRegistrationInformation($admin_name, $pid, $subpid, $admin_secret, $secret, $cms_email, $cms_password)
	{
		kJobsManager::addMailJob(
			...
			0, 
			$pid, 
			signupAction::KALTURAS_CMS_REGISTRATION_CONFIRMATION, 
			kMailJobData::MAIL_PRIORITY_NORMAL, 
			'registration_confirmation@kaltura.com', 
			'Kaltura', 
			$cms_email, 
			array($admin_name,$pid,$subpid,$cms_email,$cms_password,$admin_secret,$secret,$cms_email,$cms_password));
	}
