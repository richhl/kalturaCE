...
<form method="post">
	<fieldset>
		...
		<br />
		<label for="conversion-engines">Conversion engines:</label><br /> 
		<input type="text" id="conversion-engines" name="conversion-engines" value="<?php echo $editFlavorParam->getConversionEngines(); ?>" size="60" /> (Delimited with ",")<br />
		<label for="conversion-engines-extra-params">Extra params:</label><br /> 
		<input type="text" id="conversion-engines-extra-params" name="conversion-engines-extra-params" value="<?php echo $editFlavorParam->getConversionEnginesExtraParams(); ?>" size="60" /> (Delimited with "|")
		<br /> 
