...
class PartnerMapBuilder {
	...
	public function doBuild()
	{
		...
		$tMap->addColumn('MONITOR_USAGE', 'MonitorUsage', 'int', CreoleTypes::INTEGER, false, null);

		$tMap->addColumn('PRIORITY_GROUP_ID', 'PriorityGroupId', 'int', CreoleTypes::INTEGER, false, null);

		$tMap->addColumn('WORK_GROUP_ID', 'WorkGroupId', 'int', CreoleTypes::INTEGER, false, null);

		$tMap->addColumn('PARTNER_GROUP_TYPE', 'PartnerGroupType', 'int', CreoleTypes::SMALLINT, false, null);

		$tMap->addColumn('PARTNER_PARENT_ID', 'PartnerParentId', 'int', CreoleTypes::INTEGER, false, null);

		$tMap->addColumn('KMC_VERSION', 'KmcVersion', 'string', CreoleTypes::VARCHAR, false, 15);
