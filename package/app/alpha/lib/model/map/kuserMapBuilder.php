...
class kuserMapBuilder {
	...
	public function doBuild()
	{
		...
		$tMap->addColumn('INDEXED_PARTNER_DATA_INT', 'IndexedPartnerDataInt', 'int', CreoleTypes::INTEGER, false, null);

		$tMap->addColumn('INDEXED_PARTNER_DATA_STRING', 'IndexedPartnerDataString', 'string', CreoleTypes::VARCHAR, false, 64);
