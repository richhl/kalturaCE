...
abstract class BaseentryPeer {
	...
	public static function doCountJoinaccessControl(Criteria $criteria, $distinct = false, $con = null)
	{
				$criteria = clone $criteria;
		...
		$criteria->addJoin(entryPeer::ACCESS_CONTROL_ID, accessControlPeer::ID);
	...
	public static function doCountJoinconversionProfile2(Criteria $criteria, $distinct = false, $con = null)
	{
		...
		$criteria->addJoin(entryPeer::CONVERSION_PROFILE_ID, conversionProfile2Peer::ID);
	...
	public static function doSelectJoinaccessControl(Criteria $c, $con = null)
	{
		$c = clone $c;
		...
		entryPeer::addSelectColumns($c);
		$startcol = (entryPeer::NUM_COLUMNS - entryPeer::NUM_LAZY_LOAD_COLUMNS) + 1;
		accessControlPeer::addSelectColumns($c);

		$c->addJoin(entryPeer::ACCESS_CONTROL_ID, accessControlPeer::ID);
		$rs = BasePeer::doSelect($c, $con);
		$results = array();
		...
		while($rs->next()) {
			...
			$omClass = accessControlPeer::getOMClass();
			...
			$newObject = true;
			foreach($results as $temp_obj1) {
				$temp_obj2 = $temp_obj1->getaccessControl(); 				if ($temp_obj2->getPrimaryKey() === $obj2->getPrimaryKey()) {
					$newObject = false;
										$temp_obj2->addentry($obj1); 					break;
				}
			}
	...
	public static function doSelectJoinconversionProfile2(Criteria $c, $con = null)
	{
		...
		$c->addJoin(entryPeer::CONVERSION_PROFILE_ID, conversionProfile2Peer::ID);
		$rs = BasePeer::doSelect($c, $con);
		$results = array();
	...
	public static function doSelectJoinAll(Criteria $c, $con = null)
	{
		...
		accessControlPeer::addSelectColumns($c);
		$startcol5 = $startcol4 + accessControlPeer::NUM_COLUMNS;

		conversionProfile2Peer::addSelectColumns($c);
		$startcol6 = $startcol5 + conversionProfile2Peer::NUM_COLUMNS;
		...
		while($rs->next()) {
			...
			for ($j=0, $resCount=count($results); $j < $resCount; $j++) {
				$temp_obj1 = $results[$j];
				$temp_obj4 = $temp_obj1->getaccessControl(); 				if ($temp_obj4->getPrimaryKey() === $obj4->getPrimaryKey()) {
					$newObject = false;
					$temp_obj4->addentry($obj1); 					break;
				}
			}
			...
			for ($j=0, $resCount=count($results); $j < $resCount; $j++) {
				$temp_obj1 = $results[$j];
				$temp_obj5 = $temp_obj1->getconversionProfile2(); 				if ($temp_obj5->getPrimaryKey() === $obj5->getPrimaryKey()) {
					$newObject = false;
					$temp_obj5->addentry($obj1); 					break;
				}
			}
	...
	public static function doCountJoinAllExceptaccessControl(Criteria $criteria, $distinct = false, $con = null)
	{
				$criteria = clone $criteria;
	...
	public static function doSelectJoinAllExceptkshow(Criteria $c, $con = null)
	{
		...
		accessControlPeer::addSelectColumns($c);
		$startcol4 = $startcol3 + accessControlPeer::NUM_COLUMNS;

		conversionProfile2Peer::addSelectColumns($c);
		$startcol5 = $startcol4 + conversionProfile2Peer::NUM_COLUMNS;
		...
		while($rs->next()) {
			...
			for ($j=0, $resCount=count($results); $j < $resCount; $j++) {
				$temp_obj1 = $results[$j];
				$temp_obj3 = $temp_obj1->getaccessControl(); 				if ($temp_obj3->getPrimaryKey() === $obj3->getPrimaryKey()) {
					$newObject = false;
					$temp_obj3->addentry($obj1);
					break;
				}
			}
			...
			for ($j=0, $resCount=count($results); $j < $resCount; $j++) {
				$temp_obj1 = $results[$j];
				$temp_obj4 = $temp_obj1->getconversionProfile2(); 				if ($temp_obj4->getPrimaryKey() === $obj4->getPrimaryKey()) {
					$newObject = false;
					$temp_obj4->addentry($obj1);
					break;
				}
			}
	...
	public static function doSelectJoinAllExceptaccessControl(Criteria $c, $con = null)
	{
		$c = clone $c;
