...
abstract class BasePriorityGroupPeer {
	...
	const CLASS_DEFAULT = 'lib.model.PriorityGroup';
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_COLNAME => array (PriorityGroupPeer::ID, PriorityGroupPeer::CREATED_AT, PriorityGroupPeer::CREATED_BY, PriorityGroupPeer::UPDATED_AT, PriorityGroupPeer::UPDATED_BY, PriorityGroupPeer::NAME, PriorityGroupPeer::DESCRIPTION, PriorityGroupPeer::PRIORITY, PriorityGroupPeer::BULK_PRIORITY, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_COLNAME => array (PriorityGroupPeer::ID => 0, PriorityGroupPeer::CREATED_AT => 1, PriorityGroupPeer::CREATED_BY => 2, PriorityGroupPeer::UPDATED_AT => 3, PriorityGroupPeer::UPDATED_BY => 4, PriorityGroupPeer::NAME => 5, PriorityGroupPeer::DESCRIPTION => 6, PriorityGroupPeer::PRIORITY => 7, PriorityGroupPeer::BULK_PRIORITY => 8, ),
	...
	{
		include_once 'lib/model/map/PriorityGroupMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.PriorityGroupMapBuilder');
	}
	
	public static function getPhpNameMap()
	{
		if (self::$phpNameMap === null) {
			$map = PriorityGroupPeer::getTableMap();
	...
	const COUNT = 'COUNT(priority_group.ID)';
	const COUNT_DISTINCT = 'COUNT(DISTINCT priority_group.ID)';
	...
	public static function doCount(Criteria $criteria, $distinct = false, $con = null)
	{
		...
		if ($distinct || in_array(Criteria::DISTINCT, $criteria->getSelectModifiers())) {
			$criteria->addSelectColumn(PriorityGroupPeer::COUNT_DISTINCT);
		} else {
			$criteria->addSelectColumn(PriorityGroupPeer::COUNT);
		}
		...
		$rs = PriorityGroupPeer::doSelectRS($criteria, $con);
		if ($rs->next()) {
			return $rs->getInt(1);
		} else {
						return 0;
	...
	{
		return PriorityGroupPeer::populateObjects(PriorityGroupPeer::doSelectRS($criteria, $con));
	}
	...
	public static function populateObjects(ResultSet $rs)
	{
		$results = array();
				...
				$cls = PriorityGroupPeer::getOMClass();
	...
	{
		return PriorityGroupPeer::CLASS_DEFAULT;
	}
	...
	public static function doInsert($values, $con = null)
	{
		...
		$criteria->remove(PriorityGroupPeer::ID); 
	...
	public static function doDeleteAll($con = null)
	{
	 ...
	 public static function doDelete($values, $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			$criteria = clone $values; 		} elseif ($values instanceof PriorityGroup) {
	...
	public static function doValidate(PriorityGroup $obj, $cols = null)
	{
		...
		$res =  BasePeer::doValidate(PriorityGroupPeer::DATABASE_NAME, PriorityGroupPeer::TABLE_NAME, $columns);
    if ($res !== true) {
        $request = sfContext::getInstance()->getRequest();
        foreach ($res as $failed) {
            $col = PriorityGroupPeer::translateFieldname($failed->getColumn(), BasePeer::TYPE_COLNAME, BasePeer::TYPE_PHPNAME);
...
if (Propel::isInit()) {
			try {
		BasePriorityGroupPeer::getMapBuilder();
	} catch (Exception $e) {
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
	}
} else {
			require_once 'lib/model/map/PriorityGroupMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.PriorityGroupMapBuilder');
}
