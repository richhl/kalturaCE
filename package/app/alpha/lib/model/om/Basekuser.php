...
abstract class Basekuser extends BaseObject  implements Persistent {
	...
	protected $lastUploadTokenCriteria = null;
	...
	public function getUploadTokens($criteria = null, $con = null)
	{
				include_once 'lib/model/om/BaseUploadTokenPeer.php';
		if ($criteria === null) {
			$criteria = new Criteria();
		}
		elseif ($criteria instanceof Criteria)
		...
		if ($this->collUploadTokens === null) {
			if ($this->isNew()) {
			   $this->collUploadTokens = array();
				...
				$criteria->add(UploadTokenPeer::KUSER_ID, $this->getId());
	...
	public function countUploadTokens($criteria = null, $distinct = false, $con = null)
	{
				include_once 'lib/model/om/BaseUploadTokenPeer.php';
		if ($criteria === null) {
			$criteria = new Criteria();
		...
		return UploadTokenPeer::doCount($criteria, $distinct, $con);
	}

	
	public function addUploadToken(UploadToken $l)
	{
		$this->collUploadTokens[] = $l;
		$l->setkuser($this);
	}
