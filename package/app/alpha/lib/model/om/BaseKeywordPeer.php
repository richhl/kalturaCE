...
abstract class BaseKeywordPeer {
	...
	const ENTITY_ID = 'keyword.ENTITY_ID';

	
	const ENTITY_TYPE = 'keyword.ENTITY_TYPE';

	
	const ENTITY_COLUMNS = 'keyword.ENTITY_COLUMNS';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Word', 'EntityId', 'EntityType', 'EntityColumns', ),
		BasePeer::TYPE_COLNAME => array (KeywordPeer::WORD, KeywordPeer::ENTITY_ID, KeywordPeer::ENTITY_TYPE, KeywordPeer::ENTITY_COLUMNS, ),
		BasePeer::TYPE_FIELDNAME => array ('word', 'entity_id', 'entity_type', 'entity_columns', ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
	);

	
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Word' => 0, 'EntityId' => 1, 'EntityType' => 2, 'EntityColumns' => 3, ),
		BasePeer::TYPE_COLNAME => array (KeywordPeer::WORD => 0, KeywordPeer::ENTITY_ID => 1, KeywordPeer::ENTITY_TYPE => 2, KeywordPeer::ENTITY_COLUMNS => 3, ),
		BasePeer::TYPE_FIELDNAME => array ('word' => 0, 'entity_id' => 1, 'entity_type' => 2, 'entity_columns' => 3, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(KeywordPeer::WORD);

		$criteria->addSelectColumn(KeywordPeer::ENTITY_ID);

		$criteria->addSelectColumn(KeywordPeer::ENTITY_TYPE);

		$criteria->addSelectColumn(KeywordPeer::ENTITY_COLUMNS);

	}

	const COUNT = 'COUNT(keyword.WORD)';
	const COUNT_DISTINCT = 'COUNT(DISTINCT keyword.WORD)';
	...
	public static function doUpdate($values, $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$comparison = $criteria->getComparison(KeywordPeer::WORD);
			$selectCriteria->add(KeywordPeer::WORD, $criteria->remove(KeywordPeer::WORD), $comparison);
	...
	public static function doDeleteAll($con = null)
	{
	 ...
	 public static function doDelete($values, $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			$criteria->add(KeywordPeer::WORD, (array) $values, Criteria::IN);
		}
	...
	public static function retrieveByPK($pk, $con = null)
	{
		...
		$criteria->add(KeywordPeer::WORD, $pk);
	...
	public static function retrieveByPKs($pks, $con = null)
	{
		...
		if (empty($pks)) {
			...
			$criteria->add(KeywordPeer::WORD, $pks, Criteria::IN);
