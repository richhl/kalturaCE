...
abstract class BasePartnerPeer {
	...
	const WORK_GROUP_ID = 'partner.WORK_GROUP_ID';
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(PartnerPeer::WORK_GROUP_ID);
