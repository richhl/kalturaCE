...
//			alert("saved="+saved);
		...
		openKcw : function(ks, conversion_profile) {
			...
			var params = {
				...
				quality: "high",
//				wmode: "opaque" ,
				movie: kmc.vars.service_url + "/kcw/ui_conf_id/48614"
			};
...
//				wmode				: "opaque"
		...
		content : {
			...
			flashvars : {
				...
				moderationUiconf	: "48510",
				drilldownUiconf		: "48508",
...
//			alert("flavor_details.asset_id="+flavor_details.asset_id);
		...
		embed_code_template :	{
			...
			kaltura_links :		'<a href="http://corp.kaltura.com">video platform</a> <a href="http://corp.kaltura.com/technology/video_management">' +
								'video management</a> <a href="http://corp.kaltura.com/solutions/overview">video solutions</a> ' +
			...
			media_seo_info :	'<a rel="media:thumbnail" href="http://{CDN_HOST}/p/{PARTNER_ID}/sp/{PARTNER_ID}00/thumbnail{ENTRY_ID}/width/120/height/90/bgcolor/000000/type/2" /> ' +
								...
								'<span property="media:type" content="application/x-shockwave-flash" /><span property="media:duration" content="{DURATION}" />',
