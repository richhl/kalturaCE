...
class KalturaFrontController 
{
    ...
    private function KalturaFrontController() 
    {
        ...
        $this->service = isset($_GET["service"]) ? $_GET["service"] : null;
	...
	public function run()
	{
	    if(KalturaPluginMgr::isPlugin($this->service))
	    {
		KalturaPluginMgr::addPluginByServiceName($this->service);
	    }
	...
	public function handleMultiRequest()
	{
	    ...
	    {
		if(KalturaPluginMgr::isPlugin($currentRequest["service"]))
		{
		    KalturaPluginMgr::addPluginByServiceName($currentRequest["service"]);
		}
