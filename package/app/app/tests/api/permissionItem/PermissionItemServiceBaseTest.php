...
abstract class PermissionItemServiceBaseTest extends KalturaApiUnitTestCase
{
	 ...
	 * @dataProvider provideData
	 */
	public function testList(KalturaPermissionItemFilter $filter = null, KalturaFilterPager $pager = null, KalturaPermissionItemListResponse $reference)
	{
	 ...
	 */
	protected function validateList(KalturaPermissionItemFilter $filter = null, KalturaFilterPager $pager = null, KalturaPermissionItemListResponse $reference)
	{
	}
