...
Use the <a target="_blank" href="/kmc">Kaltura Management Console (KMC)</a>!<br />The KMC supports content ingestion, media and playlist management, wyswyg application studio for creating media players, rich-media syndication, advertising and more.<br />Learn more in the <a target="_blank" href="/lib/pdf/KMC_Quick_Start_Guide__Cassiopea.pdf">KMC quick start guide.</a>
</div>
...
<div style="clear:both;"></div>
		...
		<h3>How do I integrate Kaltura CE media into my website?</h3>
			...
			<li>Write your own: Use the <a href="http://www.kaltura.org/kaltura-api-client-libraries-guide" target="_blank">client libraries</a>, Kaltura CE <a href="/api_v3/testmeDoc" target="_blank">REST APIs</a> &amp; <a href="/api_v3/testme" target="_blank">API test console</a>.</li>
			</ul>
