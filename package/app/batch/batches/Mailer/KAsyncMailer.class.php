...
class KAsyncMailer extends KBatchBase
{
	...
	private $texts_array; // will hold the configuration of the in file
	 ...
	 */
	private function send(KalturaBatchJob $job, KalturaMailJobData $data)
	{
	...
	private function sendEmail( $recipientemail, $recipientname, $type, $subjectParams, $bodyParams, $culture, $fromemail , $fromname, $isHtml = false  )
	{
