...
{
	const IN_STR = "__inFileName__"; 
	const OUT_STR = "__outFileName__";
	const CONFIG_STR = "__configFileName__";
	const OUT_DIR_STR = "__outDir__";
	 ...
	 */
	public static function getInstance ( $type , KSchedularTaskConfig $engine_config, $entryId )
	{
		$engine =  null;
	...
	abstract public function simulate ( KalturaSourceJobData $data );
	 ...
	 * 
	 * @param KalturaSourceJobData $data
	 * @return array 
	 */
	abstract public function convert ( KalturaSourceJobData &$data );
	...
	protected function getQuickStartCmdLine($add_log)
	{
		...
		$exec_cmd = "$exe " . 
			str_replace ( 
				array ( self::IN_STR , self::OUT_STR , self::CONFIG_STR ) , 
	 ...
	 * @param string $str
	 */
	protected static function addToLogFile ( $file_name , $str )
	{
