...
class Xml2As3ClientGenerator extends ClientGeneratorFromXml 
{
	...
	private function createVoClass( $xml )
	{
		...
		if($xml->attributes()->base)
		{
			$str .= "		override public function getParamKeys():Array\n";
			$str2 = "override public function getUpdateableParamKeys():Array\n";
		}
		else
		{
			$str .= "		public function getParamKeys():Array\n";
			$str2 = "public function getUpdateableParamKeys():Array\n";
		}
		$str .= "		{\n";
		$str2 .="		{\n";
		...
		if($xml->attributes()->base)
		{
			$str .= "			arr = super.getParamKeys();\n";
			$str2 .= "			arr = super.getUpdateableParamKeys();\n";
		}
		else
		{
			$str .= "			arr = new Array();\n"; 
		...
		foreach($xml->children() as $child)
		{
			...
			if($child->attributes()->readOnly == "0" && $child->attributes()->insertOnly == "0")
				$str2 .= "			arr.push('" . $child->attributes()->name . "');\n";
		}
