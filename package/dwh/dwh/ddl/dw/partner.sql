...
CREATE TABLE `kalturadw`.`dwh_dim_partners` (
  ...
  `admin_name` VARCHAR(50) CHARACTER SET latin1 COLLATE latin1_general_ci DEFAULT 'missing value',
  `admin_email` VARCHAR(50) CHARACTER SET latin1 COLLATE latin1_general_ci DEFAULT 'missing value',
  `description` VARCHAR(1024) CHARACTER SET latin1 COLLATE latin1_general_ci DEFAULT 'missing value',
