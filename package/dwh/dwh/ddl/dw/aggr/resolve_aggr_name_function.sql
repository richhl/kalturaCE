...
DROP FUNCTION IF EXISTS `kalturadw`.`resolve_aggr_name`$$

CREATE DEFINER=`etl`@`%` FUNCTION `kalturadw`.`resolve_aggr_name`(aggr_name VARCHAR(100),field_name VARCHAR(100)) 
