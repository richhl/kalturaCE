Kaltura Community Edition (KalturaCE_1.5_Beta)
====================
Kaltura inc.
...
Flash/Flex Clients -
1. Kaltura Management Console (KMC) - Content managment, Application Studio for creating and customizing players and playlists, account management.
...
Integration Level - 
1. API Client library generator for php5,php4, .NET-C#, AS3 Flash, AS3 Flex.

Hardware and software requirements
====================
Apache 2.2, Mysql 5 and PHP 5.2.2+.
OS depends on the binary package you downloaded. (available binary packages for: Linux 32/64bit, OSX 32bit, win32)
